...
uint256 hashGenesisBlock("0x0000047462b7a97ff0e85630d00e57352d98ab4c17156273f22415fe8d78a104");
static const unsigned int timeGenesisBlock = 1377640567;
...
static const int64 nTargetTimespan = 500 * 60; // approx 8 hours
static const int64 nTargetSpacing = 60; // 60 seconds
static const int64 nInterval = nTargetTimespan / nTargetSpacing; // 500 blocks
...
if(nHeight < 500)
    ...
    // Subsidy is cut in half every 2.1 million blocks
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Past intervals worth of blocks.
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000ddb5211c09372fef81d256f5afd98b4ba4e807dd664ee2829b30d84269d");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0xb1814844a286d66d0b6e00966209606002adeb72b8cb8f3db72aa4c96f5da2e9"));
...
unsigned char pchMessageStart[4] = { 0xfc, 0xb4, 0xd9, 0xab };
