...
const QString BITCOIN_IPC_PREFIX("securecoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click securecoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start securecoin: click-to-pay handler");
    else
...
{
    // clicking on securecoin: URLs creates FileOpen events on the Mac:
